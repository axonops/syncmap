...
**Attribution rule.** Commit messages, PR descriptions, code comments, and any other tracked artefact **must not** reference Claude, Anthropic, Copilot, GPT, LLM, or "AI-generated". The CI `attribution-guard` job will reject the PR.
